...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
            ...
            <li><a href="index.php" class="active"><i class='bx bxs-inbox icon'></i>Productos</a></li>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-success btn-sm text-center edit_product" product="<?php echo $mostrar['id_producto']; ?>" href="">
