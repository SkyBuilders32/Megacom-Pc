...
<?php  $consulta_c = mysqli_query($con, "SELECT * FROM productos");?>
<?php  $consulta_co = mysqli_query($con, "SELECT * FROM facturas_compras");?>
<div class="modal fade" id="nuevo" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel">Nueva Compra</h5>
                ...
                <form method="POST" action="nuevo.php" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="floatingSelect">Selecciona el Producto</label>
                                <select class="form-select" id="floatingSelect" aria-label="Producto" name="producto">
                                    <?php
                                    while ($pr = mysqli_fetch_array($consulta_c)){
                            ...
                            <div class="mb-3">
                                ...
                                <input type="numjber" class="form-control" name="cantidad" required>
                            </div>

                        <div class="col-md-6">                            
                            <div class="mb-3">
                                <label class="form-label">valor_compra</label>
                                <input type="number" class="form-control" name="valor_compra" required>
                            </div>
                        </div>
                        <div class="mb-3">
                                <label for="floatingSelect">Selecciona la factura</label>
                                <select class="form-select" id="floatingSelect" aria-label="factura" name="factura">
                                    <?php
                                    while ($pr = mysqli_fetch_array($consulta_co)){
