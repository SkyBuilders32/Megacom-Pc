...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="clientes/index.php"><i class='bx bxs-widget icon' ></i>Proveedores</a></li>
			<li><a href="clientes/index.php"><i class='bx bxs-widget icon' ></i>Pedidos</a></li>
			<li><a href="clientes/index.php"><i class='bx bxs-widget icon' ></i>Facturas</a></li>
