...
<<<<<<< HEAD
			<li><a href="../productos/index.php"><i class='bx bxs-inbox icon' ></i> Productos</i></a></li>
			<li><a href="index.php"><i class='bx bxs-chart icon'></i>Usuarios</a></li>
...
>>>>>>> 79ccaee694f8c8623ae9f5a01b2acbad238c4a34
							...
							while ($mostrar = $query->fetch_assoc()) { ?>
								<tr>
									...
									<td class="text-center">
										<a href="#edit_<?php echo $mostrar['id']; ?>" class="btn btn-success btn-sm text-center"
											data-bs-toggle="modal">
											<i class='bx bxs-pencil'></i></a>
										<a href="#delete_<?php echo $mostrar['id']; ?>" class="btn btn-danger btn-sm text-center"
											data-bs-toggle="modal">
